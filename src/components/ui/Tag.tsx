...
const tag = tv({
  base: 'flex items-center justify-center rounded-full border border-purple-100 px-4 py-1 text-base text-purple-100 transition-all duration-200 ease-in-out hover:bg-purple-200 hover:text-gray-100',
  variants: {
    active: {
